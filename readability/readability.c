...
int main(void)
{
    ...
    float L = (count_letters(text) / (float) count_words(text)) *
              100; // Avg number of letters per 100 words in the text
    float S = (count_sentences(text) / (float) count_words(text)) *
              100; // Avg number of sentences per 100 words in the text
